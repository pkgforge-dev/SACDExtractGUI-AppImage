...
# SACDExtractGUI-AppImage 🐧

[![GitHub Downloads](https://img.shields.io/github/downloads/pkgforge-dev/SACDExtractGUI-AppImage/total?logo=github&label=GitHub%20Downloads)](https://github.com/pkgforge-dev/SACDExtractGUI-AppImage/releases/latest)
[![CI Build Status](https://github.com/pkgforge-dev/SACDExtractGUI-AppImage/actions/workflows/appimage.yml/badge.svg)](https://github.com/pkgforge-dev/SACDExtractGUI-AppImage/releases/latest)
...
## ⚠️ On first run, enter `~/.config/SACDExtractGUI/sacd_extract` in Program field ⚠️
